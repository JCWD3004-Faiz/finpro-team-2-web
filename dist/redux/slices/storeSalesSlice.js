...
exports.fetchSalesData = (0, toolkit_1.createAsyncThunk)("sales/fetchSalesData", (_a, _b) => __awaiter(void 0, [_a, _b], void 0, function* ({ year }, { rejectWithValue }) {
    var _c;
    try {
        if (!store_id) {
            return rejectWithValue("Store ID is missing in cookies.");
        }
        const response = yield interceptor_1.default.get(`/api/store-admin/sales/?year=${year}&store_id=${store_id}`, {
            headers: {
...
exports.fetchSalesByProductData = (0, toolkit_1.createAsyncThunk)("sales/fetchSalesByProductData", (_a, _b) => __awaiter(void 0, [_a, _b], void 0, function* ({ year, product_id }, { rejectWithValue }) {
    var _c;
    try {
        if (!store_id) {
            return rejectWithValue("Store ID is missing in cookies.");
        }
        const response = yield interceptor_1.default.get(`/api/store-admin/sales/products/?year=${year}&store_id=${store_id}&product_id=${product_id}`, {
            headers: {
                Authorization: `Bearer ${access_token}`,
            },
        });
...
exports.fetchCategoriesProductStoreData = (0, toolkit_1.createAsyncThunk)("storeAdmin/fetchCategoriesProductStoreData", (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { rejectWithValue }) {
    var _b;
    try {
        const response = yield interceptor_1.default.get("/api/store-admin/data/all", {
            headers: {
                Authorization: `Bearer ${access_token}`,
            },
        });
...
exports.fetchSalesByCategory = (0, toolkit_1.createAsyncThunk)("sales/fetchSalesByCategory", (_a, _b) => __awaiter(void 0, [_a, _b], void 0, function* ({ year, category_id }, { rejectWithValue }) {
    var _c, _d;
    try {
        if (!store_id) {
            return rejectWithValue("Store ID is missing in cookies.");
        }
        const response = yield interceptor_1.default.get("/api/store-admin/sales/categories/", {
