...
const superStockSlice_1 = require("@/redux/slices/superStockSlice.js");
...
function AllStocksReports() {
    ...
    const { stocksData, currentPage, totalPages, storeId, loading, error } = (0, react_redux_1.useSelector)((state) => state.superStock);
    const handlePageChange = (page) => {
        if (page > 0 && page <= totalPages) {
            dispatch((0, superStockSlice_1.setCurrentPage)(page));
        }
    };
    (0, react_1.useEffect)(() => {
        dispatch((0, superStockSlice_1.fetchStocksSuper)({
            page: currentPage,
            storeId: storeId,
...
exports.default = AllStocksReports;
