...
function PaymentFailed() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (user_id && transaction_id) {
            dispatch((0, checkoutSlice_1.failedMidtransPaymentStatus)({ user_id, transaction_id }));
    ...
    return (react_1.default.createElement("div", { className: "min-h-screen bg-background flex items-center justify-center p-4 bg-white" },
        react_1.default.createElement(card_1.Card, { className: "w-full max-w-lg p-8 space-y-6" },
            react_1.default.createElement("div", { className: "flex flex-col items-center text-center space-y-4" },
                react_1.default.createElement("div", { className: "rounded-full bg-red-100 p-3" },
                    react_1.default.createElement(lucide_react_1.AlertCircle, { className: "w-12 h-12 text-red-600" })),
                react_1.default.createElement("h1", { className: "text-2xl font-bold text-foreground" }, "Payment Failed..."),
                react_1.default.createElement("p", { className: "text-muted-foreground" }, "We're sorry, but your payment cannot be processed."),
            ...
            react_1.default.createElement("div", { className: "border-t pt-6" },
                react_1.default.createElement("div", { className: "space-y-2" },
                    ...
                    react_1.default.createElement("div", { className: "text-sm text-muted-foreground" },
                        ...
                        (paymentDetails === null || paymentDetails === void 0 ? void 0 : paymentDetails.payment_method) && react_1.default.createElement("p", null, "Payment Reference: N/A"),
